...
fn draw_logo(stdout: &mut io::Stdout) {
    // Brand colors: lavender → indigo → blue → sky → cyan → teal
    const C: [&str; 6] = [
        "\x1b[1;38;2;167;139;250m",
        "\x1b[1;38;2;129;140;248m",
        "\x1b[1;38;2;99;179;237m",
        "\x1b[1;38;2;56;189;248m",
        "\x1b[1;38;2;34;211;238m",
        "\x1b[1;38;2;94;234;212m",
    ];
    let r = RESET;
    let _ = writeln!(stdout, "\r");
    let _ = writeln!(
        stdout,
        "  {0}\u{2588}\u{2588}\u{2588}\u{2557}  \u{2588}\u{2588}\u{2557}{6} {1} \u{2588}\u{2588}\u{2588}\u{2588}\u{2588}\u{2588}\u{2557} {6} {2} \u{2588}\u{2588}\u{2588}\u{2588}\u{2588}\u{2588}\u{2557}{6} {3} \u{2588}\u{2588}\u{2588}\u{2588}\u{2588}\u{2588}\u{2557} {6} {4}\u{2588}\u{2588}\u{2588}\u{2588}\u{2588}\u{2588}\u{2557} {6} {5}\u{2588}\u{2588}\u{2588}\u{2588}\u{2588}\u{2588}\u{2588}\u{2557}{6}\r",
        C[0], C[1], C[2], C[3], C[4], C[5], r
    );
    let _ = writeln!(
        stdout,
        "  {0}\u{2588}\u{2588}\u{2588}\u{2588}\u{2557} \u{2588}\u{2588}\u{2551}{6} {1}\u{2588}\u{2588}\u{2554}\u{2550}\u{2550}\u{2550}\u{2588}\u{2588}\u{2557}{6} {2}\u{2588}\u{2588}\u{2554}\u{2550}\u{2550}\u{2550}\u{2550}\u{255D}{6} {3}\u{2588}\u{2588}\u{2554}\u{2550}\u{2550}\u{2550}\u{2588}\u{2588}\u{2557}{6} {4}\u{2588}\u{2588}\u{2554}\u{2550}\u{2550}\u{2588}\u{2588}\u{2557}{6} {5}\u{2588}\u{2588}\u{2554}\u{2550}\u{2550}\u{2550}\u{2550}\u{255D}{6}\r",
        C[0], C[1], C[2], C[3], C[4], C[5], r
    );
    let _ = writeln!(
        stdout,
        "  {0}\u{2588}\u{2588}\u{2554}\u{2588}\u{2588}\u{2557}\u{2588}\u{2588}\u{2551}{6} {1}\u{2588}\u{2588}\u{2551}   \u{2588}\u{2588}\u{2551}{6} {2}\u{2588}\u{2588}\u{2551}     {6} {3}\u{2588}\u{2588}\u{2551}   \u{2588}\u{2588}\u{2551}{6} {4}\u{2588}\u{2588}\u{2551}  \u{2588}\u{2588}\u{2551}{6} {5}\u{2588}\u{2588}\u{2588}\u{2588}\u{2588}\u{2557}  {6}\r",
        C[0], C[1], C[2], C[3], C[4], C[5], r
    );
    let _ = writeln!(
        stdout,
        "  {0}\u{2588}\u{2588}\u{2551}\u{255A}\u{2588}\u{2588}\u{2588}\u{2588}\u{2551}{6} {1}\u{2588}\u{2588}\u{2551}   \u{2588}\u{2588}\u{2551}{6} {2}\u{2588}\u{2588}\u{2551}     {6} {3}\u{2588}\u{2588}\u{2551}   \u{2588}\u{2588}\u{2551}{6} {4}\u{2588}\u{2588}\u{2551}  \u{2588}\u{2588}\u{2551}{6} {5}\u{2588}\u{2588}\u{2554}\u{2550}\u{2550}\u{255D}  {6}\r",
        C[0], C[1], C[2], C[3], C[4], C[5], r
    );
    let _ = writeln!(
        stdout,
        "  {0}\u{2588}\u{2588}\u{2551} \u{255A}\u{2588}\u{2588}\u{2588}\u{2551}{6} {1}\u{255A}\u{2588}\u{2588}\u{2588}\u{2588}\u{2588}\u{2588}\u{2554}\u{255D}{6} {2}\u{255A}\u{2588}\u{2588}\u{2588}\u{2588}\u{2588}\u{2588}\u{2557}{6} {3}\u{255A}\u{2588}\u{2588}\u{2588}\u{2588}\u{2588}\u{2588}\u{2554}\u{255D}{6} {4}\u{2588}\u{2588}\u{2588}\u{2588}\u{2588}\u{2588}\u{2554}\u{255D}{6} {5}\u{2588}\u{2588}\u{2588}\u{2588}\u{2588}\u{2588}\u{2588}\u{2557}{6}\r",
        C[0], C[1], C[2], C[3], C[4], C[5], r
    );
    let _ = writeln!(
        stdout,
        "  {0}\u{255A}\u{2550}\u{255D}  \u{255A}\u{2550}\u{2550}\u{255D}{6} {1} \u{255A}\u{2550}\u{2550}\u{2550}\u{2550}\u{2550}\u{255D} {6} {2} \u{255A}\u{2550}\u{2550}\u{2550}\u{2550}\u{2550}\u{255D}{6} {3} \u{255A}\u{2550}\u{2550}\u{2550}\u{2550}\u{2550}\u{255D} {6} {4}\u{255A}\u{2550}\u{2550}\u{2550}\u{2550}\u{2550}\u{255D} {6} {5}\u{255A}\u{2550}\u{2550}\u{2550}\u{2550}\u{2550}\u{2550}\u{255D}{6}\r",
        C[0], C[1], C[2], C[3], C[4], C[5], r
    );
    let _ = writeln!(stdout, "\r");
}
