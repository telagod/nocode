...
fn pseudo_random_bytes(len: usize) -> Vec<u8> {
    ...
    let mut seed: u64 = nanos ^ cnt.wrapping_mul(6_364_136_223_846_793_005) ^ tid_hash.len() as u64;
...
pub fn build_authorization_url(config: &OAuthConfig, pkce: &PkceCodePair, state: &str) -> String {
